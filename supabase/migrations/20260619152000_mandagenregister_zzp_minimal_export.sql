-- =====================================================================
-- Mandagenregister: dataminimalisatie ZZP-export
-- - Voor ZZP zijn naam + KvK-nummer voldoende voor de standaard export.
-- - BSN/ID/geboortedatum/nationaliteit worden niet vereist voor ZZP.
-- - Loondienst behoudt de bestaande strengere persoonscontrole.
-- =====================================================================
...
BEGIN
  ...
  WITH geplande_dagen AS (
    ...
    SELECT
      ...
      gd.activiteit_count,
      CASE
        WHEN m.dienstverband = 'zzp' THEN ARRAY_REMOVE(ARRAY[

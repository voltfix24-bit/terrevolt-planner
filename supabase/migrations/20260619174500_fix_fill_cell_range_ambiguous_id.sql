-- Fix voor doortrekken van planningcellen.
-- De RPC geeft RETURNS TABLE(id, week_id, dag_index) terug. Daardoor bestaan
-- id/week_id/dag_index ook als plpgsql output-variabelen binnen de functie.
-- Alle tabelkolommen worden hieronder expliciet gequalified zodat PostgreSQL
-- niet meer kan struikelen op: column reference "id" is ambiguous.
